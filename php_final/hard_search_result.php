...
?>
        ...
        <?php
        $sql2 = "select * from hard where $catagory like '%$search_con%' order by idx desc";
       ...
       ?>
        <table class="list-table">
          ...
          $title=$board["title"]; 
            ...
            $sql3 = "select * from hard_reply where con_num='".$board['idx']."'";
        ...
        ?>
            <tbody>
              ...
              { ?><a href='hard_ck_read.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
              }else{?>
          ...
          ?>
                            ...
                            <a href='hard_read.php?idx=<?php echo $board["idx"]; ?>'><span><?php echo $title; }?></span><span
