...
?>
        ...
        <?php
        $sql2 = "select * from moon where $catagory like '%$search_con%' order by idx desc";
       ...
       ?>
        <table class="list-table">
          ...
          $title=$board["title"]; 
            ...
            $sql3 = "select * from moon_reply where con_num='".$board['idx']."'";
        ...
        ?>
            <tbody>
              ...
              { ?><a href='moon_ck_read.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
              }else{?>
          ...
          ?>
                            ...
                            <a href='moon_read.php?idx=<?php echo $board["idx"]; ?>'><span><?php echo $title; }?></span><span
