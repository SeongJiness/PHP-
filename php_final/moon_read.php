...
<body>
    <?php
        ...
        $hit = "select * from moon where idx ='".$bno."'";
        $hit = mysqli_query($con, $hit);
		$hit = mysqli_fetch_array($hit);
		$hit = $hit['hit'] + 1;
        $fet = "update moon set hit = '".$hit."' where idx = '".$bno."'";
        $fet = mysqli_query($con, $fet);
        $sql = "select * from moon where idx='".$bno."'";
    ...
    <div id="board_read">
        ...
        <div id="bo_ser">
            <ul>
                <li><a href="moon.php">[목록으로]</a></li>
                <li><a href="moon_thumbup.php?idx=<?php echo $board['idx']; ?>">[추천]</a></li>
                <?php
               if(isset($_SESSION['userid']) && $_SESSION['userid'] == $board['name']) {
                echo '<li><a href="moon_modify.php?idx='. $board['idx']. '">[수정]</a></li>';
                echo '<li><a href="moon_answer.php?idx='. $board['idx']. '">[삭제]</a></li>';
            }
                ?>
            </ul>
        </div>
    ...
    <div class="reply_view">
        <h3>댓글목록</h3>
        <?php
			$sql3 = "select * from moon_reply where con_num='".$bno."' order by idx desc";
        ...
        <div class="dap_lo">
            ...
            <!-- 댓글 수정 폼 dialog -->
            <div class="dat_edit">
                <form method="post" action="moon_rep_modify_ok.php">
            ...
            <div class='dat_delete'>
                <form action="moon_reply_delete.php" method="post">
                    <input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" />
                    <input type="hidden" name="b_no" value="<?php echo $bno; ?>">
        ...
        <!--- 댓글 입력 폼 -->
        <div class="dap_ins">
            <form action="moon_reply.php?idx=<?php echo $bno; ?>" method="post">
