...
<body>
    ...
    $hit = "select * from hard where idx ='".$bno."'";
    ...
    <div id="board_read">
        ...
        <div id="bo_ser">
            <ul>
                <li><a href="hard.php">[목록으로]</a></li>
                <li><a href="hard_thumbup.php?idx=<?php echo $board['idx']; ?>">[추천]</a></li>
                <?php
               if(isset($_SESSION['userid']) && $_SESSION['userid'] == $board['name']) {
                echo '<li><a href="hard_modify.php?idx='. $board['idx']. '">[수정]</a></li>';
                echo '<li><a href="hard_answer.php?idx='. $board['idx']. '">[삭제]</a></li>';
            }
                ?>
            </ul>
        </div>
    ...
    <div class="reply_view">
        <h3>댓글목록</h3>
        <?php
			$sql3 = "select * from hard_reply where con_num='".$bno."' order by idx desc";
        ...
        <div class="dap_lo">
            ...
            <div class='dat_delete'>
                <form action="hard_reply_delete.php" method="post">
                    <input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" />
                    <input type="hidden" name="b_no" value="<?php echo $bno; ?>">
        ...
        <!--- 댓글 입력 폼 -->
        <div class="dap_ins">
            <form action="hard_reply.php?idx=<?php echo $bno; ?>" method="post">
