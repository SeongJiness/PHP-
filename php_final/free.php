                ...
                <tr>
                    ...
                    <td width="500"><?php
                     ...
                     if($board['lock_post'] == "1") {
                        ?><a href="free_ck_read.php?idx=<?php echo $board["idx"];?>"><?php echo $title, $lockimg, $img; 
                     }else {?>
                            <a href="free_read.php?idx=<?php echo $board["idx"];?>"><?php echo $title,$img;}?></a>
                    </td>
