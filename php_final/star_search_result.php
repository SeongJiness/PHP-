...
?>
        ...
        <?php
        $sql2 = "select * from star where $catagory like '%$search_con%' order by idx desc";
       ...
       ?>
        <table class="list-table">
          ...
          $title=$board["title"]; 
            ...
            $sql3 = "select * from star_reply where con_num='".$board['idx']."'";
        ...
        ?>
            <tbody>
              ...
              { ?><a href='star_ck_read.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
              }else{?>
          ...
          ?>
                            ...
                            <a href='star_read.php?idx=<?php echo $board["idx"]; ?>'><span><?php echo $title; }?></span><span
